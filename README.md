...
1. This video shows 7min the **ref test ride** with setting the light.state from simulator in file [tl_detector.py -> get_light_state](./ros/src/tl_detector/tl_detector.py).

[Reference Video](./vids/vokoscreen-2018-05-26_10-21-36_light.state.mkv)

2. This video shows 7min test ride using a [**simpler FCN**](./ros/src/tl_detector/light_classification/model/inf_graph_sim.pb) to classify traffic light state.

[Model 1 Video](./vids/vokoscreen-2018-05-26_10-40-32_graph_sim.mkv)

3. This video shows 7min test ride using a [**more complex FCN**](ros/src/tl_detector/light_classification/model/frozen_inf_vatsal5kPlus2k.pb) to classify traffic light state and some fixes


[Model 2 Video](./vids/final.avi)
